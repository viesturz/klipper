...
data class ParametricThermistor(val c1: Double, val c2: Double, val c3: Double): TemperatureSensor {
    ...
    companion object {
        ...
        fun make(point1: ResistanceCalibration,
                 point2: ResistanceCalibration,
                 point3: ResistanceCalibration): ParametricThermistor {
            ...
            val ln_r1 = ln(point1.r);val ln3_r1 = pow(ln_r1, 3.0)
            val ln_r2 = ln(point2.r);val ln3_r2 = pow(ln_r2, 3.0)
            val ln_r3 = ln(point3.r);val ln3_r3 = pow(ln_r3, 3.0)
            val inv_t12 = inv_t1 - inv_t2; val inv_t13 = inv_t1 - inv_t3
            val ln_r12 = ln_r1 - ln_r2; val  ln_r13 = ln_r1 - ln_r3
            val ln3_r12 = ln3_r1 - ln3_r2; val  ln3_r13 = ln3_r1 - ln3_r3
...
private fun calcPT(base: Float, t: Temperature): Resistance {
    ...
    val A = 3.9083e-3; val B = -5.775e-7
    val k = t.kelvins
